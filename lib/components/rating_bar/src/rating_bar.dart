...
class RatingBar extends StatefulWidget {
  ...
  /// only 1 rating widget is allowed to shine. This often use if rating bar is
  /// emoji (example: terrible, normal, happy...)
  final bool isShowOnly1Rating;
...
class _RatingBarState extends State<RatingBar> {
  ...
  Widget _buildRating(BuildContext context, int index) {
    ...
    if (index >= _rating || (index < _rating - 1 && widget.isShowOnly1Rating)) {
